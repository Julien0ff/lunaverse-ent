    ...
    <div className="space-y-6 animate-fadeIn relative z-10">
      <div>
        <h2 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400 drop-shadow-sm flex items-center gap-3">
          <FileText className="w-10 h-10 text-discord-blurple drop-shadow-[0_0_10px_rgba(88,101,242,0.5)]" />
          Déclarations
        </h2>
        <p className="text-discord-muted mt-2 font-medium uppercase tracking-widest text-xs">Taxes et impôts</p>
      </div>
